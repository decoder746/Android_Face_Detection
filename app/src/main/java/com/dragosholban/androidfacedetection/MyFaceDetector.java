...
//            Bitmap faceBitmap = Bitmap.createBitmap(bmp, (int)(face.getPosition().x-face.getWidth()/2),(int)(face.getPosition().y-face.getHeight()/2),(int)(face.getWidth()),(int)(face.getHeight()));
...
//            Bitmap lefteyeBitmap = Bitmap.createBitmap(bmp, (int)(face.getPosition().x+3*face.getWidth()/10),(int)(face.getPosition().y+3*face.getHeight()/8),40,40);
//            Bitmap righteyeBitmap = Bitmap.createBitmap(bmp,(int)(face.getPosition().x+7*face.getWidth()/10),(int)(face.getPosition().y+3*face.getHeight()/8),40,40);
